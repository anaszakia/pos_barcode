                ...
                @foreach($orders as $order)
                    <tr>
                       ...
                       <td>
                            ...
                            <a href="{{ route('admin.orderan.print', $order->id) }}" 
                            ...
                            <form action="{{ route('admin.orderan.destroy', $order->id) }}" method="POST" class="d-inline" id="delete-form-{{ $order->id }}">
                                @csrf
                                @method('DELETE')
                                <button 
                                    type="button" 
                                    ...
                                    <i class="fas fa-trash"></i> {{-- Icon tempat sampah untuk hapus --}}
                                </button>
                            </form>
                        </td>
                    </tr>
...
<div class="modal fade" id="createModal" tabindex="-1">     
    <div class="modal-dialog modal-lg">         
        <form action="{{ route('admin.orderan.store') }}" method="POST" class="modal-content">             
            @csrf             
