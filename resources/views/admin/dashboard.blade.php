                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <p class="stats-label mb-1">Total Order</p>
                            <h4 class="stats-value mb-0">{{ number_format($totalOrder) }}</h4>
            ...
            <div class="stats-card">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <p class="stats-label mb-1">Total Reservasi</p>
                            <h4 class="stats-value mb-0">{{ number_format($totalReservasi) }}</h4>
                            <small class="text-success">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="quick-action-card">
                <div class="card-body text-center p-4">
                    ...
                    <a href="{{ route('admin.orderan.index') }}" class="btn btn-outline-primary btn-sm">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="quick-action-card">
                <div class="card-body text-center p-4">
                    ...
                    <a href="{{ route('admin.reservasi.index') }}" class="btn btn-outline-info btn-sm">
